...
import { Article } from 'entities/Articles/model/types/article';
...
const Template: ComponentStory<typeof ArticleDetailsPage> = (args) => <ArticleDetailsPage {...(args as Record<string, unknown>)} />;
